import { TOPIC_META, CORE_TOPIC_ORDER, VOCABO_TOPIC_ORDER, ALL_TOPIC_DATA } from '../data/topicData.js';

const COUNT_OPTIONS = [50, 100];

export default function TopicSelect({ group = 'core', onStart, onBack, onRevise, onVoiceStart, onTeachStart, syncing }) {
  const isVocabo = group === 'vocabo';
  const topicOrder = isVocabo ? VOCABO_TOPIC_ORDER : CORE_TOPIC_ORDER;
  return (
      ...
      <div style={styles.body}>
        ...
        {topicOrder.map(tid => (
          <TopicCard
            ...
            onStart={onStart}
            onRevise={onRevise}
            onVoiceStart={['idioms','vocabopediaIdioms','oneWordSubs','vocabopediaOneWordSubs','proverbs','vocabopediaProverbs','oxymorons','vocabopediaOxymorons','similes','vocabopediaSimiles','antonyms','vocabopediaAntonyms','synonyms','vocabopediaSynonyms','collectiveNouns'].includes(tid) ? onVoiceStart : undefined}
